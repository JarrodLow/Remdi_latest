...
<body style="background-color: #ffffff;">
	<div class="login-clean" style="background-color: #ffffff;padding: 20px 0px;">
		...
		<h3 style="color: rgb(255,255,255);padding: 6px;font-size: 20px;">Forget&nbsp;PASSWORD<br></h3>
			...
			<a class="forgot" href="loginAdmin.php" style="color: #ffffff;">Already have an account? CLICK here</a>
			<a class="forgot" href="registerAdmin.php" style="color: #ffffff;">New User click here</a>
		</form>
	</div>
