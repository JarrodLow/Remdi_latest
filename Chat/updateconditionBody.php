...
";
    ...
    $sql = "INSERT INTO user_condition SET questionnaire_id = '$questionnaire_id', condition_image = '$condition_image', upload_time = now(), type = 'Body' ";
    // execute query
...
$result = mysqli_query($conn, "SELECT * FROM user_condition WHERE type = 'Body'") or die(mysqli_error($conn));;
?>
<!DOCTYPE html>
<html>
    ...
    <div style="margin: 12px;background-color: #ffffff;">
        <div id="content" style="background-color: #a2d1ea;">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<img style='width: 100px;height: 100px;' src='user_condition/" . $row['condition_image'] . "' ><a href='wholePage.php?cimage=" .$row['condition_image']. "'>View Image</a>";
                echo "<p style='color: #000000;background-color: rgba(0,0,0,0);margin: 0px;'>" . $row['upload_time'] . "</p>";
                echo "</div>";
            }
            ?>
            <form method="POST" action="updateconditionBody.php" enctype="multipart/form-data" style="padding: 6px;">
