...
";
    ...
    $sql = "INSERT INTO user_condition SET questionnaire_id = '$questionnaire_id', condition_image = '$condition_image', upload_time = now(), type = 'RightLeg' ";
    // execute query
...
$result = mysqli_query($conn, "SELECT * FROM user_condition WHERE type = 'RightLeg'") or die(mysqli_error($conn));;
?>
<!DOCTYPE html>
<html>
...
<body style="background-color: #ffffff;">
    <div class="d-flex page-content-wrapper" style="background-color: #007abb;">
        ...
        <h3 style="color: #ffffff;font-family: 'Carter One', cursive;margin: 12px;">Right&nbsp;Leg&nbsp;Condition<br></h3>
    </div>
        ...
        <div style="margin: 12px;background-color: #a2d1ea;">
            <div id="content">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    echo "<div id='img_div' class='text-center' style='background-color: #ececec;padding: 6px;'>";
                ...
                ?>
                <form method="POST" action="updateconditionRightLeg.php" enctype="multipart/form-data" style="padding: 6px;">
