...
<body style="background-color: #ffffff;">
  ...
  <div class="login-clean" style="background-color: #ffffff;padding: 20px;">
    <form class="shadow-none" action="register.php" method="post" enctype="multipart/form-data" class="shadow-none" style="background-color: #178ccb;padding: 20px;padding-top: 0px;">
      ...
      <div class="form-group"><button class="btn btn-primary btn-block border rounded shadow" type="submit" name="save_profile" style="background-color: #11d3c7;">Register<br></button></div>
      <a class="forgot" href="login.php" style="color: #ffffff;">Have an account? Click here.</a>
    </form>
  </div>
