...
";
    ...
    $sql = "INSERT INTO user_condition SET questionnaire_id = '$questionnaire_id', condition_image = '$condition_image', upload_time = now(), type = 'RightHand' ";
    // execute query
...
$result = mysqli_query($conn, "SELECT * FROM user_condition WHERE type = 'RightHand'") or die(mysqli_error($conn));;
?>
<!DOCTYPE html>
<html>
...
<body style="background-color: #ffffff;">
    <div class="d-flex page-content-wrapper" style="background-color: #007abb;">
        ...
        <h3 style="color: #ffffff;font-family: 'Carter One', cursive;margin: 12px;">Right&nbsp;Hand&nbsp;Condition<br></h3>
    </div>
    <div style="margin: 12px;background-color: #ffffff;">
        <div style="margin: 12px;background-color: #a2d1ea;">
            <div id="content">
                ...
                ?>
                <form method="POST" action="updateconditionRightHand.php" enctype="multipart/form-data" style="padding: 6px;">
